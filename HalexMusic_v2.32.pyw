...
class MusicPlayer:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🎵 HalexMusic 2.32V")
    ...
    def get_color_scheme(self):
        schemes = {
            "normal": {
                ...
                'social_btn': '#2d1b69', 'viz_bg': '#0a0a0a'
            },
            "deuteranopia": {
                ...
                'social_btn': '#8B7500', 'viz_bg': '#0a0a0a'
            },
            "tritanopia": {
                ...
                'mini_secondary': '#161b22', 'hotkeys': '#777', 'copyright': '#666',
                'social_btn': '#CC5500', 'viz_bg': '#0a0a0a'
            },
            "protanopia": {
                ...
                'mini_secondary': '#161b22', 'hotkeys': '#777', 'copyright': '#666',
                'social_btn': '#0080AA', 'viz_bg': '#0a0a0a'
            }
        }
    ...
    def setup_ui(self):
        ...
        tk.Button(pl_btns, text="💾", font=('Arial', 7), bg=c['btn_bg'], fg='white', relief='flat', padx=6, command=self.export_playlist).pack(side='left', padx=1)
        ...
        tk.Label(bottom_frame, text="© 2026 HalexMusic 2.32V | github.com/MIAU-rgb/HalexMusic", 
        ...
        social_btn_cfg = {'font': ('Arial', 6, 'bold'), 'bg': c['social_btn'], 'fg': 'white', 'relief': 'flat', 'padx': 8, 'pady': 1}
    ...
    def create_mini_player(self):
        ...
        # Безопасное позиционирование с учётом панели задач
        ...
        tk.Label(tb, text="HALEX 2.32V", font=('Segoe UI', 5, 'bold'), fg=ra, bg=rs).pack(side='left', padx=4)
    ...
    def do_move_mini(self, event):
        if self.mini_x and self.mini_y:
            ...
            # Ограничение перемещения (защита от ухода за экран)
            screen_w = self.root.winfo_screenwidth()
            screen_h = self.root.winfo_screenheight()
            taskbar_h = 48
            mini_w = 280
    ...
    def refresh_music(self):
        ...
        self.shuffled_tracks = []
        self.original_tracks = []
        messagebox.showinfo("HalexMusic 2.32V", "Музыка обновлена!")
